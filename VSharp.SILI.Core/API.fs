...
module API =
    ...
    module Types =
        ...
        let CanCast targetType term = TypeCasting.canCast m.Value targetType term
    ...
    module public Memory =
        ...
        let MutateArrayElement state arrayRef indices value k = Memory.mutateArrayElement m.Value state arrayRef indices value k
    ...
    module RuntimeExceptions =
        ...
        let IndexOutOfRangeException state thrower =
            ...
            thrower term, state
        let ArrayTypeMismatchException state thrower =
            let term, state = Memory.atme m.Value state
            thrower term, state
