...
module internal Types =
    ...
    let (|StructureType|_|) = function
        | StructType _ -> Some(StructureType)
        | Numeric _ -> Some(StructureType)
    ...
    let (|ReferenceType|_|) = function
        | ClassType _ -> Some(ReferenceType)
        | InterfaceType _ -> Some(ReferenceType)
    ...
    let (|ComplexType|_|) = function
        | StructureType
        | ReferenceType -> Some(ComplexType)
